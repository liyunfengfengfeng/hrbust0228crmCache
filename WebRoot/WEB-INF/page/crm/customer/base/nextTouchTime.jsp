...
<body>
<s:form name="form1" method="post" action="crmCustomerAction_updateNextTouchTime.do" namespace="/crm"  onsubmit="return check();">
...
<table width="100%" border="0" cellpadding="0" cellspacing="10" class="tabForm">
	<tr>
        ...
        <td width="70%">
             <input type='text' class="dateClassStyle"  id='next_touch_date' name='nextTouchDate' value=''  style='width:50%'>
        </td>
	</tr>
</table>
</s:form>
