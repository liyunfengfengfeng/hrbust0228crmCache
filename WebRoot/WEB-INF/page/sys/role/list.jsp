...
<table width="100%" border="0" cellspacing="0" cellpadding="0" name="base" id="base">
	<tr>
    	<td width="38%" nowrap>名称：
			<s:textfield name="name"  id="name" value="" cssStyle="width:140px"/>
    	</td>
  	    <td width="39%" nowrap>&nbsp;</td>
  	    <td width="23%" align="center">
		<div class="control">
		<!-- 设置js时要使用onClick属性时要设置两个单词的函数要不然不好使 -->
		...
		<button type='button' class='button' onMouseOver="this.className='button_over';" onMouseOut="this.className='button';"  
		        onClick="clearContent();"><img src="${pageContext.request.contextPath}/ui/images/button/qingkong.png" border='0' align='absmiddle'>&nbsp;清空</button>
		</div>
		</td>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="PowerTable" class="PowerTable">
	...
	<tr>
    	<td width="6%" class="listViewThS1">
   	    	<s:checkbox id="checkall" name="checkall" value="" cssClass="checkbox" onClick="checkAll()"/>
   	    </td>
