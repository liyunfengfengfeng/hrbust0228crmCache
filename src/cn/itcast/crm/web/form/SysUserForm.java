...
public class SysUserForm implements Serializable{
	...
	private String beginDate;// 起始有效期
	private String endDate;// 终止有效期
	private String roleId;// 权限组id 外键roleId 多个用户对应一个权限组
	private String groupId;// 所属部门 外键groupId 多个用户对应一个部门
